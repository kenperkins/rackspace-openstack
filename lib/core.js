/*
 * core.js: Core functions for accessing the Rackspace API
 *
 ...
 * @param {Function}   callback    handles the callback of your api call
 */
Client.prototype.createDomain = function(details, callback) {
    var self = this;
 ...
 * @param {Function}    callback    handles the callback of your api call
 */
Client.prototype.updateDomain = function(domain, callback) {
 ...
 * @param {Function}    callback    handles the callback of your api call
 */
Client.prototype.updateDomains = function(domains, callback) {
    var self = this;
 ...
 * @param {Function}            callback            handles the callback of your api call
 */
Client.prototype.deleteDomain = function(domain, deleteSubdomains, callback) {
 ...
 * @param {Function}            callback            handles the callback of your api call
 */
Client.prototype.deleteDomains = function(domains, deleteSubdomains, callback) {
    var self = this;
 ...
 * @param {Function}            callback    handles the callback of your api call
 */
Client.prototype.getDomains = function(details, callback) {
    var self = this;
 ...
 * @param {Function}    callback    handles the callback of your api call
 */
Client.prototype.getDomain = function(id, callback) {
    var self = this;
